describe('First test suite', () => {
  ...
  it('second test', () => {
    ...
    // contains() - find HTML text and by text and locator, first match
  ...
  it('date-pickers', () => {
    ...
    cy.contains('nb-card', 'Common Datepicker')
      ...
      .then(input => {
        cy.wrap(input).click();
        this.selectDateFromCurrent(futureDay, futureMonth, futureYear.toString());
...
function selectDateFromCurrent(futureDay: number, futureMonth: string, futureYear: string): void {
    ...
    .then(dateAttribute => {
        if (!dateAttribute.includes(futureMonth) || !dateAttribute.includes(futureYear)) {
          cy.get('[data-name="chevron-right"]')
            .click();
          this.selectDateFromCurrent(futureDay, futureMonth, futureYear);
        } else {
          cy.get('.day-cell')
            .not('.bounding-month')
            .contains(futureDay)
